...
import logging
from node_rules_return_node import cgcr_oxygen_tree, cgcr_aluminium_prediction, vag_aluminium_prediction
...
def main():
    ...
    if len(run_heats) != 0:
        ...
        if len(ads) > 0:
            ...
            ads.to_excel("testing_second_pass.xlsx", index = False)
